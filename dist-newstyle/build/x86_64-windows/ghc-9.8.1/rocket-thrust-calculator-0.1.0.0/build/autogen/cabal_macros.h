...
/* package rocket-thrust-calculator-0.1.0.0 */
#ifndef VERSION_rocket_thrust_calculator
#define VERSION_rocket_thrust_calculator "0.1.0.0"
#endif /* VERSION_rocket_thrust_calculator */
#ifndef MIN_VERSION_rocket_thrust_calculator
#define MIN_VERSION_rocket_thrust_calculator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rocket_thrust_calculator */
/* package Chart-1.9.5 */
...
#define CURRENT_PACKAGE_KEY "rocket-thrust-calculator-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "rocket-thrust-calculator-0.1.0.0-inplace"
